  ...
  return (
    <div>
      ...
      <div className="centeredContent" style={{textAlign: 'left', margin: '50px'}}>
        ...
        <br />
        <p>We also brought in a few people who really changed the organisation for good. <strong>Shrey & Prudhvi</strong> from tech, <strong>Sarthak</strong> in Product, <strong>Suhas </strong> who joined much later and turned around the team really well. </p>
        <br />
